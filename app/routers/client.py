...
fake_clients_db = {"7f644301-e3f1-4752-90d5-99fbfad91ab3": {
    ...
    "password": "Secret_Pa55w0rd",
    "signup_ts": None,
    "JobSheet": ["79dc3d3a-c40b-47e8-8cf4-207c2de7e24",
                 "c85a5633-2803-4826-ae5a-82474c238c4",
                 "0348ae36-202a-4bfc-a92d-849607fd520"]
}}
...
async def register_client(data :Client):
    print(f"\n\nData: {data}")
    resp = client.register_client(data)
    print(f"\n\nresp: {resp}")
    return {resp}
...
async def read_all_clients():
    resp = client.get_all_clients()
    print(f"Client : {resp}")
    return {"Client_List": resp["profile"]}
